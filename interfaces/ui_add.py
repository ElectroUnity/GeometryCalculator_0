...
class Ui_Add(object):
    def setupUi(self, Add):
        ...
        self.gridLayout_4.addWidget(self.SubtitleLabel_2, 4, 0, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.PushButton_eq, 3, 0, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.CardWidget_2, 5, 0, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.PushButton_vertical, 2, 0, 1, 4)
        self.PushButton_parallel = PushButton(parent=Add)
        self.PushButton_parallel.setObjectName("PushButton_parallel")
        self.gridLayout_4.addWidget(self.PushButton_parallel, 1, 0, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.CheckBox_pre_simplify, 0, 3, 1, 1)
        self.Theme_toggle = TransparentPushButton(FluentIcon.CONSTRACT, "切换主题", parent=Add)
        self.Theme_toggle.setObjectName("Theme_toggle")
        self.gridLayout_4.addWidget(self.Theme_toggle, 0, 2, 1, 1)
...
"")
    ...
    def retranslateUi(self, Add):
        ...
        self.Theme_toggle.setText(_translate("Add", "切换主题"))
        self.BodyLabel.setText(_translate("Add", "删除点/条件"))
        self.PushButton_delete.setText(_translate("Add", "确认"))
from qfluentwidgets import BodyLabel, CardWidget, CheckBox, LineEdit, PushButton, SubtitleLabel, TableWidget, TitleLabel, TransparentPushButton
